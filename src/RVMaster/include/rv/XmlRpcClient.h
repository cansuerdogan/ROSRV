...
#ifndef RVCPP_XMLRPCCLIENT_H_
#define RVCPP_XMLRPCCLIENT_H_
//
...
namespace rv {
  ...
  public:
    ...
    bool executeNonBlock(const char* method, XmlRpc::XmlRpcValue const& params);
    bool executeCheckDone(XmlRpc::XmlRpcValue& result);
  ...
  protected:
    ...
    virtual bool generateRequest(const char* method, XmlRpc::XmlRpcValue const& params);
    virtual std::string generateHeader(std::string const& body);
    virtual bool writeRequest();
    virtual bool readHeader();
    virtual bool readResponse();
    virtual bool parseResponse(XmlRpc::XmlRpcValue& result);
